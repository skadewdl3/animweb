  ...
  <div class="user-controls-wrapper">
    <div class="user-controls-buttons-container">
      ...
      <div class="code-controls">
        <button class="code-button" :disabled="!ready" @click="editor.run()">
          Play
        </button>
        <button class="code-button" :disabled="!ready" @click="editor.clear()">
          Clear
        </button>
        ...
        <button
          ...
          :disabled="!ready"
        >
          <span :disabled="!ready" :class="{ godown: code.mode == '2D' }"
            >Switch to 2D</span
          >
          <span :disabled="!ready" :class="{ goup: code.mode == '3D' }"
            >Switch to 3D</span
          >
        </button>
      </div>
